...
function DBdltb(type, queryurl_tb) {
    ...
    getMapInfo(queryurl_tb, function (resArr, totalArea) {
        var str = "";
        var queryMC;
        $('#totalAreaTd').html(totalArea.toFixed(2) + "（亩）");
        if (type == "dl") { //按地类查询
            queryMC = "地类名称";
            var dlObject = {};
            ...
            str += '<tr>';
            str += ' <td>基本农田</td>';
            str += ' <td>' + nyydArea.toFixed(2) + '（亩）</td>';
            str += '</tr>';
            str += '<tr>';
            str += ' <td>非基本农田</td>';
            str += ' <td>' + fnyydArea.toFixed(2) + '（亩）</td>';
            str += '</tr>';
            ...
            str += '<tr>';
            str += ' <td>建设用地</td>';
            str += ' <td>' + jsydArea.toFixed(2) + '（亩）</td>';
            str += '</tr>';
            str += '<tr>';
            str += ' <td>非建设用地</td>';
            str += ' <td>' + fjsydArea.toFixed(2) + '（亩）</td>';
            str += '</tr>';
        }
...
function detailed(index, title) {
    ...
    if (detailed.length == 0) {
        ...
        for (var i = 0; i < detailed.length; i++) {
            ...
            str += "<td>" + detailed[i].CTMJ.toFixed(2) + "(亩)</td>";
            str += "<td>" + detailed[i].TBMJ.toFixed(2) + "(亩)</td>";
            str += "</tr>";
        }
