...
layui.define(['jquery'],function (exports) {
    ...
    var obj = (function (e) {
        ...
        var r = !1, i = !1, n = 0, s = 2e3, l = 0, a = e, c = ["ms", "moz", "webkit", "o"],
        ...
        var m = window.MutationObserver || window.WebKitMutationObserver || !1, f = {
            ...
            this.canhwscroll = x.hastransform && v.opt.hwacceleration, this.ishwscroll = this.canhwscroll && v.haswrapper, this.istouchcapable = !1, x.cantouch && x.iswebkit && !x.isios && !x.isandroid && (this.istouchcapable = !0, x.cantouch = !1), x.cantouch && x.ismozilla && !x.isios && !x.isandroid && (this.istouchcapable = !0, x.cantouch = !1), v.opt.enablemouselockapi || (x.hasmousecapture = !1, x.haspointerlock = !1), this.delayed = function (e, o, t, r) {
                ...
                } : i && i.tt || (v.delaylist[e] = {last: n, tt: 0}, setTimeout(function () {
                    o.call()
                }, 0))))
            ...
            this.getOffset = function () {
                ...
                if (x.hasmstouch && v.css(v.ispage ? a("html") : v.win, {"-ms-touch-action": "none"}), v.zindex = "auto", v.zindex = v.ispage || "auto" != v.opt.zindex ? v.opt.zindex : c() || "auto", v.ispage || "auto" == v.zindex || v.zindex > l && (l = v.zindex), v.isie && 0 == v.zindex && "auto" == v.opt.zindex && (v.zindex = "auto"), !v.ispage || !x.cantouch && !x.isieold && !x.isie9mobile) {
                    ...
                    if (v.ispage) d.css({
                        ...
                        top: "0px",
                        height: "100%"
                    }), d.css(d.align ? {right: "0px"} : {left: "0px"}), v.body.append(d), v.railh && (w.css({
                        position: "fixed",
                        left: "0px",
                        width: "100%"
                    }), w.css(w.align ? {bottom: "0px"} : {top: "0px"}), v.body.append(w));
                    else {
                        if (v.ishwscroll) {
                            ...
                            v.zoom && (v.zoom.css({
                                ...
                                position: "absolute",
                                top: 0
                            }), d.css(d.align ? {right: 0} : {left: 0}), y.append(d), w && (w.css({
                                position: "absolute",
                                left: 0,
                                bottom: 0
                            }), w.css(w.align ? {bottom: 0} : {top: 0}), y.append(w))
                        } else {
                        ...
                        if (x.cantouch || v.istouchcapable || v.opt.touchbehavior || x.hasmstouch) {
                            ...
                            v.ontouchmove = function (e, o) {
                                ...
                                if (v.rail.drag && 2 == v.rail.drag.pt) {
                                    ...
                                    var s = e.clientY + ofy, l = s - v.rail.drag.y, c = e.clientX + i,
                                        d = c - v.rail.drag.x, u = v.rail.drag.st - l;
                ...
                v.cursortimeout && (clearTimeout(v.cursortimeout), v.cursortimeout = 0), v.rail && (v.autohidedom && (v.autohidedom.stop().css({opacity: v.opt.cursoropacitymax}), v.cursoractive = !0), v.rail.drag && 1 == v.rail.drag.pt || (void 0 !== e && e !== !1 && (v.scroll.y = Math.round(1 * e / v.scrollratio.y)), void 0 !== o && (v.scroll.x = Math.round(1 * o / v.scrollratio.x))), v.cursor.css({
